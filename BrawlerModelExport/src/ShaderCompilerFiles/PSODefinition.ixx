...
export import :VIRTUAL_TEXTURE_PAGE_TILING_POINT;
export import :VIRTUAL_TEXTURE_PAGE_TILING_BILINEAR;
export import :VIRTUAL_TEXTURE_PAGE_TILING_TRILINEAR;
export import :VIRTUAL_TEXTURE_PAGE_TILING_ANISOTROPIC;
export import :VIRTUAL_TEXTURE_PAGE_TILING_POINT_SRGB;
export import :VIRTUAL_TEXTURE_PAGE_TILING_BILINEAR_SRGB;
export import :VIRTUAL_TEXTURE_PAGE_TILING_TRILINEAR_SRGB;
export import :VIRTUAL_TEXTURE_PAGE_TILING_ANISOTROPIC_SRGB;
export import :VIRTUAL_TEXTURE_PAGE_MERGING_POINT;
export import :VIRTUAL_TEXTURE_PAGE_MERGING_BILINEAR;
export import :VIRTUAL_TEXTURE_PAGE_MERGING_TRILINEAR;
export import :VIRTUAL_TEXTURE_PAGE_MERGING_ANISOTROPIC;
export import :VIRTUAL_TEXTURE_PAGE_MERGING_POINT_SRGB;
export import :VIRTUAL_TEXTURE_PAGE_MERGING_BILINEAR_SRGB;
export import :VIRTUAL_TEXTURE_PAGE_MERGING_TRILINEAR_SRGB;
export import :VIRTUAL_TEXTURE_PAGE_MERGING_ANISOTROPIC_SRGB;
