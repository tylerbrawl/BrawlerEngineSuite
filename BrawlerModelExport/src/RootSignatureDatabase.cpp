...
namespace
{
	...
	__forceinline void AddRootSignatureCreationJob(std::array<Microsoft::WRL::ComPtr<Brawler::D3D12RootSignature>, std::to_underlying(Brawler::RootSignatures::RootSignatureID::COUNT_OR_ERROR)>& rsArray, Brawler::JobGroup& jobGroup)
	{
		...
		if constexpr ((std::to_underlying(RSIdentifier) + 1) != std::to_underlying(Brawler::RootSignatures::RootSignatureID::COUNT_OR_ERROR))
...
namespace Brawler
{
	namespace D3D12
	{
		void RootSignatureDatabase::InitializeDatabase()
		{
