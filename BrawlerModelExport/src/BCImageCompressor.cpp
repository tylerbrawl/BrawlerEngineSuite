...
module Brawler.BCImageCompressor;
import Brawler.D3D12.Texture2D;
import Brawler.D3D12.ScopedGPUResourceMapping;
import Brawler.D3D12.GPUResourceDescriptors.DescriptorTableBuilder;
import Brawler.D3D12.GPUJobSystem;
...
namespace Brawler
{
	BCImageCompressor::BCImageCompressor(const DirectX::Image& srcImage, const DXGI_FORMAT desiredFormat) :
		mSrcImagePtr(&srcImage),
	...
	/*
	bool BCImageCompressor::IsMipLevelSpanValid() const
	{
	...
	*/
	...
	void BCImageCompressor::CompressImage(DirectX::Image& destImage)
	{
		assert(destImage.format == mDesiredFormat && "ERROR: A DirectX::Image with an unexpected format was provided for BCImageCompressor::CompressImage()!");
	...
	void BCImageCompressor::InitializeBuffers()
	{
