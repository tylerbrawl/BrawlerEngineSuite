...
namespace Brawler
{
	...
	static constexpr std::size_t MAX_VERTEX_BUFFER_ELEMENTS = (static_cast<std::size_t>(1) << 22);
	static constexpr std::size_t MAX_INDEX_BUFFER_ELEMENTS = (static_cast<std::size_t>(1) << 22);
	static constexpr std::size_t MAX_MODEL_INSTANCES = (static_cast<std::size_t>(1) << 16);
