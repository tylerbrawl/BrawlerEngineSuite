...
namespace Brawler
{
	GPUSceneBufferUpdateSubModule::BufferUpdateRenderPass_T GPUSceneBufferUpdateSubModule::CreateGPUSceneBufferUpdateRenderPass(D3D12::FrameGraphBuilder& builder)
	{
		/*
		...
		*/
		...
		return gpuSceneBufferUpdatePass;
	}
}