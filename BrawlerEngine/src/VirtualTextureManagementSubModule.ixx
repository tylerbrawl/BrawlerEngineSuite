...
export namespace Brawler
{
	...
	public:
		...
		using GlobalTextureUpdatePass_T = GlobalTextureUpdater::GlobalTextureUpdatePass_T;
	...
	public:
		...
		GlobalTextureUpdatePass_T CreateGlobalTextureUpdatesRenderPass() const;
