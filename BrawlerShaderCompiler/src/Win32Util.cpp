...
namespace
{
	...
	void LoadModules()
	{
		Brawler::Win32::DLLManager::GetInstance().LoadModule(L"dxil.dll", Brawler::Win32::ModuleSearchPath::APPLICATION_LIBRARY_DIRECTORY); 
		Brawler::Win32::DLLManager::GetInstance().LoadModule(L"dxcompiler.dll", Brawler::Win32::ModuleSearchPath::APPLICATION_LIBRARY_DIRECTORY);
	}
}
